...
public class TBLogoActivity extends Activity {
    Toast mToast;
    ImageView mContent;
    int mCount;
            ...
            public boolean onLongClick(View v) {
                try {
                    startActivity(new Intent(Intent.ACTION_MAIN)
                        ...
                        .addCategory("com.android.internal.category.TBLOGO"));
                        //.setClassName("com.android.systemui","com.android.systemui.InfoCircus"));
                } catch (ActivityNotFoundException ex) {
                    android.util.Log.e("TBLogoActivity", "Couldn't find a ThinkingBridge");
                }
                finish();
                return true;
            }
