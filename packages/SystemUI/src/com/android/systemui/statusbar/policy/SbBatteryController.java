...
public class SbBatteryController extends LinearLayout {
    ...
    public static final int STYLE_ICON_XOOM = 5;
    ...
    private void setBatteryIcon(int level, boolean plugged) {
        ...
        } else if (mBatteryStyle == BATTERY_STYLE_CIRCLE || mBatteryStyle == BATTERY_STYLE_CIRCLE_PERCENT) {
        	icon = 0;
        } else {
...
>>>>>>> parent of 29df118... Themability of battery text type
            } else {
